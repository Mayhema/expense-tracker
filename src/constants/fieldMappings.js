...
export const FIELD_PATTERNS = {
  ...
  'Description': /desc|note|memo|detail|comment|text|narrative|beschreibung|descripcion|תאור|פרטים/i,
...
export function validateTransaction(transaction) {
  ...
  if (!hasMonetaryValue) {
    errors.push('Transaction must have at least one monetary value (Income, Expenses, or Balance)');
  }
