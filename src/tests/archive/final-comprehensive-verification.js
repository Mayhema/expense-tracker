 ...
 * 1. Advanced Filters dropdown visibility in BOTH dark AND regular modes
 * 2. Category dropdown height constraints removed for ALL modes
 * 3. Transaction summary white backgrounds fixed with ultimate specificity
